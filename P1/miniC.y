...
declarations    :  declarations VAR tipo var_list SEPARADOR                       {printf("Aplica program -> declarations VAR tipo var_list ; \n");}
                |  declarations CONST tipo const_list SEPARADOR                   {printf("Aplica program -> declarations CONST tippo const_list ; } \n");}
                |                                                                 {printf("Aplica program -> lambda \n");}
                ;
tipo            :  ENTERO                                                         {printf("Aplica tipo -> ENTERO \n");}
